...
func main() {
	...
	//PUBLIC ENDPOINTS
	router.HandleFunc("/login", executelogintemplate)
	router.HandleFunc("/loginHandler", LoginHandler)
	...
	//api funcs
	router.HandleFunc("/gotoindex",index)
	//router.HandleFunc("/getall",getall)

	router.HandleFunc("/getperson",executepersontemplate)      //get person by id
	router.HandleFunc("/getpersonjson",getperson)

	router.HandleFunc("/insert", executeinserttemplate)
	router.HandleFunc("/insertjson", insert)

	router.HandleFunc("/deleterec",executedeletetemplate)  //.Methods("DELETE") (how to use this along in browser and not postman)
	router.HandleFunc("/deleterecjson",deleterec)

	router.HandleFunc("/update",executeupdatetemplate)
	router.HandleFunc("/updatejson",update)

	router.HandleFunc("/query",printdata)
