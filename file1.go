...
func init() {
	...
	t=template.Must(template.ParseFiles("insertapi.gohtml","getpersonapi.gohtml","getall.gohtml","results.gohtml","updateapi.gohtml","getallapi.gohtml","finaltemplate.gohtml"))
...
func getperson(w http.ResponseWriter,r *http.Request){            //by EmpId
	...
	t.ExecuteTemplate(w,"finaltemplate.gohtml",nil)
	//fmt.Fprintln(w,s)
}
...
func insert(w http.ResponseWriter, r *http.Request) {
	...
	_, err := db.Exec(query,v1,v2, v3,v4,v5)
	check(err)
